...
static bool windowed_query_from_query(const char *query, char *buf, size_t buflen)
{
  ...
  const char *const c_nm_query_window_additional_terms =
      cs_subset_string(NeoMutt->sub, "nm_query_window_additional_terms");
  ...
  enum NmWindowQueryRc rc = nm_windowed_query_from_query(
      ...
      c_nm_query_window_timebase, c_nm_query_window_additional_terms);
